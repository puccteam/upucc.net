        ...
        <div>
          ...
          <a class="link-fx fw-bold tracking-wide mx-auto" href="index.html">
            <span class="smini-hidden">
              ...
              <span class="fs-4 text-dual">UPU</span><span class="fs-4 text-primary">CC</span>
            </span>
          </a>
        </div>
        <!-- END Logo -->
      ...
      <div class="js-sidebar-scroll">
        ...
        <div class="content-side content-side-full">
          <ul class="nav-main">
            ...
            <li class="nav-main-heading">Personal Data</li>
            <li class="nav-main-item">
                <a class="nav-main-link active" href="be_pages_dashboard.html">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link active" href="be_pages_dashboard.html">
                  <i class="nav-main-link-icon fab fa-critical-role"></i>
            ...
            <li class="nav-main-item">
                <a class="nav-main-link active" href="be_pages_dashboard.html">
                  <i class="nav-main-link-icon fa fa-hill-rockslide"></i>
            ...
            <li class="nav-main-item">
                <a class="nav-main-link active" href="be_pages_dashboard.html">
                  ...
                  <span class="nav-main-link-name">Program Kegiatan</span>
                </a>
            </li>
